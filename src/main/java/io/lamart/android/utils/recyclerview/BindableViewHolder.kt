...
fun <T> View.toHolder(block: (view: View) -> (item: T) -> Unit): BindableViewHolder<T> =
    object : BindableViewHolder<T>(this@toHolder) {

        val bind = block(this@toHolder)
